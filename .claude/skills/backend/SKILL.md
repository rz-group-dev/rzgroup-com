---
name: backend
description: "Usar siempre que se trabaje en el backend/código del sitio de RZ Group (2-rzgroup.com): comandos de dev/build, stack técnico, arquitectura de la homepage, reglas de componentes/i18n/imágenes, página de reservas, páginas de servicio, SEO y flujo de git/deploy. Consultar antes de tocar cualquier archivo de este proyecto."
metadata:
  author: cracksdigitales
  version: "1.0.0"
---

# Backend / desarrollo — RZ Group (2-rzgroup.com)

Contexto técnico del proyecto `2-rzgroup.com`, destilado de su `CLAUDE.md`. Consultar esta skill antes de implementar cambios en el código.
