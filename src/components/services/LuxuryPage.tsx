...
const VEHICLES = [
  ...
  { name: 'Sprinter Blindada', category: 'fleet.premium', seats: 15, img: '/images/fleet/Sprinter Blindada.svg' },
  { name: 'Toyota Blindada', category: 'fleet.premium', seats: 7, img: '/images/fleet/Toyota Blindada.svg' },
];
